...
/**
 * @brief Initialize an instance of a MPU6050-structure.
 * @details
...
MPU6050 new_MPU6050()
{
    ...
    // finetuned value based on the result of calc_IMU_error(self)
    self.gyro_error_y = 2.24321; // car
    // self.gyro_error_y = 0.44195; //test_rig
...
/**
 * @brief Initiates MPU6050
 * @details remove the comments if values ​​other than default values ​​are desired.
 * Calc_IMU_error is important, but can be finetuned manually.
 *
 * @param self
 */
static void init(MPU6050 *self)
...
/**
 * @brief calculates the sensors avarage drifting error
 * @details calculates the sensors average drifting error based
 * on the number of measurements that is defined to the variable iterations.
 * NOTE: important step and can be finetuned manually.
 * @param self
 */
static void calc_IMU_error(MPU6050 *self)
{
...
/**
 * @brief Experimental function to reset the pitch value.
 * @details
